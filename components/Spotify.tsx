...
const Spotify = ({
  ...
  return (
    <>
      <div className="flex items-center bg-gray-200 dark:bg-gray-900 bg-opacity-20 dark:bg-opacity-20 md:bg-transparent rounded-2xl p-4 w-80">
        <div className="grid items-center justify-center">
          <FadeIn>
            {doing?.listening_to_spotify ? (
              <>
                <div className="flex sm:flex-row sm:space-x-2 w-full space-x-4">
                  <div>
                    <img
                      src={doing.spotify.album_art_url}
                      className="flex-shrink-0 w-16 h-16 rounded-2xl"
                    />
                    <div className="absolute ml-6 equalizer">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        className="fill-current text-black dark:text-white rounded-2xl w-4 h-4 text-opacity-50"
                      >
                        <rect
                  ...
                  <div className="text-sm leading-tight overflow-y-hidden">
                    <div className="space-x-2 mt-3">
                      <div className="flex justify-between">
                        <span className="font-black text-black dark:text-white inline-flex ">
                          {doing.spotify.artist
                            .replace(/\;/g, ",")
                            .replace(/\&/g, "and")}
                        </span>
                      </div>
                      <div className="text-black dark:text-white what max-w-xs overflow-y-hidden">
                        <a
              ...
              <>
                <div className="flex flex-row-reverse sm:flex-row mb-8 sm:space-x-2 w-full mt-5 ml-2">
